...
from	ui 		import Ui_blog

import		cs_gdata.blog, core.blog, model.blog

dBlog	= None

class	BlogDialog(QtGui.QDialog, Ui_blog.Ui_BlogDialog):
	def	__init__(self, email, password):
		...
		self.blogmodel = model.blog.BlogModel(dstfeed)
