    ...
    void Soap::parseGetAddressBookResponse(std::string response)
    {
        ...
        for(int a=0;a<nItems;a++)
        {
            ...
            if(contactType=="Me"){
                ...
                std::string displayName(thisContact.getChildNode("displayName").getText());
            ...
            const char *displayn = thisContact.getChildNode("passportName").getText();
            const char *contactid1 = contacts.getChildNode("Contact", a).getChildNode("contactId").getText();

            if(displayn)
                passportName = displayn;
            else
                continue;
