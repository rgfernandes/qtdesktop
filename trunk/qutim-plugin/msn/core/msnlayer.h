...
class MSNlayer : public QObject, ProtocolInterface
{
        Q_OBJECT
...
public:
	MSNlayer();
        ...
        virtual QString name(){return "MSN";}
        virtual QString description(){return "MSN protocol realization for qutIM by Rustam Chakin";}
...
private:
	...
	QHash<QString, MSNaccount*> m_account_list;
