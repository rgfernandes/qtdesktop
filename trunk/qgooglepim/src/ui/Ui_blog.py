...
# Form implementation generated from reading ui file '/mnt/shares/home/eugene/Version/SVN/qtdesktop/trunk/qgooglepim/src/ui/blog.ui'
#
# Created: Wed Dec  1 22:09:07 2010
...
class Ui_BlogDialog(object):
    def setupUi(self, BlogDialog):
        ...
        BlogDialog.resize(554, 402)
        icon = QtGui.QIcon()
        icon.addFile("../../../../../../home/eugene/Projects/GooglePIM/src/ui/img/35x35/blogger.gif")
        BlogDialog.setWindowIcon(icon)
        ...
        self.twAuthor.setHorizontalHeaderItem(0, item)
    ...
    def retranslateUi(self, BlogDialog):
        ...
        self.twAuthor.horizontalHeaderItem(0).setText(QtGui.QApplication.translate("BlogDialog", "Name", None, QtGui.QApplication.UnicodeUTF8))
