# readme: http://habrahabr.ru/blogs/qt_software/86432/
TEMPLATE = app
VERSION = 0.0.1
TARGET = qtpdfview
QT += core gui xml
...
SOURCES += \
	...
	src/toc.cpp \
	src/viewer.cpp
INSTALLS += target desktop icon16 icon20 icon22 icon24 icon32 icon36 icon48 icon64 icon96 icon128 icon192
unix {
	isEmpty(PREFIX) {
		PREFIX = /usr
	}
