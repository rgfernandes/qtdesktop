...
#
# Description:
# - Fedora Live Spin with the QtDesktop Environment (634 packages; 350M => 210M)
#
# Maintainer(s):
...
# my
chkconfig --level 345 abrtd off 2>/dev/null
chkconfig --level 345 avahi off 2>/dev/null
